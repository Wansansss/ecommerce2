  ...
  return (
    <Container>
      ...
      <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
        <h3 className="text-black/80 text-[24px] lg:text-[28px]">{title}</h3>
        ...
        <div className="bg-white text-black text-[14px] md:text-[16px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-red-600 transition-all duration-500">
          Shop Now
        </div>
      </div>
