    ...
    <Container>
      <div className="outline-none border-none relative md:max-h-[300px] sm:max-h-[200px] lg:max-h-[300px]">
        <div className="absolute max-h-[200px] left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] gap-2">
          ...
          <h2 className="text-black text-[16px] md:text-[26px] lg:text-[40px] font-bold leading-[1.2]">
            {mainTitle}
          </h2>
          ...
          <div className="bg-red-700 text-black text-[10px] md:text-[16px] p-1 px-2 rounded-lg inline-block cursor-pointer hover:bg-black hover:text-white transition-all duration-500">
            Shop Now
          </div>
        </div>

        <Image
          className="w-full max-h-[250px] sm:max-h-[200px] rounded-xl object-cover"
          src={img}
          alt="banner"
          width={500}
          height={500}
